	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Yunus Rangga Saleh" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[1rem]" data-aos="fade-up" data-aos-duration="1200">
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Adit" Width="120px" />
					</div>
				</div>
				...
				<div className="relative top-[-22rem]" data-aos="fade-up" data-aos-duration="900">
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Pengabsen" Nama="Putri" Width="100px" />
						<div className="py-[3%]"></div>
